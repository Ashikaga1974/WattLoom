...
import { api, type Bike, type Language, type LicenseStatus, type Settings, type SingleImportResult, type WeatherStatus } from '@/lib/api';
...
export default function SettingsPage() {
  ...
  // Protokoll (nur auf Knopfdruck geladen, kein automatisches Polling)
